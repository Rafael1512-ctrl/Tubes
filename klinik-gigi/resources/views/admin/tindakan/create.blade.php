...
@section('header-title', 'Tambah Tindakan')
@section('header-subtitle', 'Masukkan detail layanan medis baru')
            ...
            <div class="card-custom shadow-sm border-0 rounded-4 overflow-hidden">
                <div class="card-header bg-white border-0 py-4 px-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="fw-bold m-0">Detail Tindakan Baru</h5>
                            <small class="text-muted">Isi formulir di bawah untuk mendaftarkan layanan</small>
                        </div>
                    </div>
                </div>

                <form action="{{ route('admin.tindakan.store') }}" method="POST" class="p-4 pt-0">
                    @csrf
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">ID Tindakan</label>
                            <input type="text" name="IdTindakan"
                                class="form-control rounded-pill px-3 @error('IdTindakan') is-invalid @enderror"
                                value="{{ old('IdTindakan', $newId) }}" required>
                            @error('IdTindakan') <div class="invalid-feedback ms-3">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="Kategori" list="kategoris"
                                ...
                                value="{{ old('Kategori') }}" placeholder="Pilih atau ketik kategori baru...">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="NamaTindakan"
                            ...
                            value="{{ old('NamaTindakan') }}" required placeholder="Contoh: Scaling Gigi">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-2">
                        ...
                        <button type="submit" class="btn btn-primary rounded-pill px-5 shadow-sm">
                            <i class="fa-solid fa-save me-2"></i>Simpan Tindakan
                        </button>
                    </div>
                </form>
            </div>
