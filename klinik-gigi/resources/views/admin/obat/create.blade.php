                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="HargaBeli" class="form-control rounded-end-3 p-2" placeholder="0" value="{{ old('HargaBeli') }}" min="0" required>
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-light border-end-0">Rp</span>
                            <input type="number" name="HargaJual" class="form-control rounded-end-3 p-2" placeholder="0" value="{{ old('HargaJual') }}" min="0" required>
                        </div>
