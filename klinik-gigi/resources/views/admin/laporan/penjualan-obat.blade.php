...
@section('content')
    ...
    <div class="report-nav d-flex flex-wrap gap-2 justify-content-center">
        ...
        <a href="{{ route('admin.laporan.penjualan-obat') }}" class="active"><i
                class="fa-solid fa-prescription-bottle me-1"></i> Penjualan Obat</a>
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-6">
            <div class="card stat-card p-4 bg-gradient text-white"
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="mb-1 opacity-75">Total Penjualan Obat</p>
        ...
        <div class="col-md-6">
            <div class="card stat-card p-4 bg-gradient text-white"
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="mb-1 opacity-75">Total Jenis Obat Terjual</p>
                        <h3 class="fw-bold mb-0">{{ $penjualan->count() }} Jenis</h3>
                    </div>
                    <i class="fa-solid fa-capsules fa-3x opacity-50"></i>
                </div>
            </div>
        </div>
    </div>
