    ...
    <div class="row g-4 mb-4">
        <div class="col-md-6">
            <div class="card stat-card p-4 text-white"
                style="background: linear-gradient(135deg, #3494E6 0%, #EC6EAD 100%) !important;">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="mb-1 opacity-75 fw-medium">Total Pendapatan Tindakan</p>
                        <h3 class="fw-bold mb-0">Rp {{ number_format($totalPendapatan, 0, ',', '.') }}</h3>
                    </div>
                    <i class="fa-solid fa-hand-holding-medical fa-3x opacity-25"></i>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card stat-card p-4 text-white"
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="mb-1 opacity-75 fw-medium">Total Tindakan</p>
                        <h3 class="fw-bold mb-0">{{ $penjualan->sum('JumlahTindakan') }}x</h3>
                    </div>
                    <i class="fa-solid fa-stethoscope fa-3x opacity-25"></i>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card stat-card p-4 text-white"
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="mb-1 opacity-75 fw-medium">Jenis Tindakan</p>
                        <h3 class="fw-bold mb-0">{{ $penjualan->count() }}</h3>
                    </div>
                    <i class="fa-solid fa-list-check fa-3x opacity-25"></i>
                </div>
            </div>
        </div>
    </div>
